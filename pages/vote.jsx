      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <p className="text-justify text-xl">
            Voting takes place on the blockchain. It is safe, unchangeable,
            transparent, unfraudulent and automated. It can be time dependent or
            the owner is able to start and end the voting.
          </p>

          <a
            href="https://github.com/hamednasr/Solidity/blob/main/poll.sol"
            target="_blank"
            rel="noreferrer"
          >
