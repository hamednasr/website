    ...
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2">ICO (Initial Coin Offering)</h2>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <p className="text-justify text-xl">
            An initial coin offering (ICO) or initial currency offering is a
            type of funding using cryptocurrencies. I wrote the contract with
            Solidity
          </p>

          <a
            href="https://github.com/hamednasr/Solidity/blob/main/ICOFinance.sol"
            target="_blank"
            rel="noreferrer"
          >
